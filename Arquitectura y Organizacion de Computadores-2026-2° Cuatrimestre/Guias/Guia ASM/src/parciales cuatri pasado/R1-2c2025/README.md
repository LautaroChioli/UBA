BYTE	1   byte	            1 byte	                        char, bool, int8_t	al, bl, cl, dl, dil
WORD	2   bytes	        2 bytes 	                        short, int16_t	ax, bx, cx, dx, di
DWORD   Double Word     4 bytes	                        32 bits	int, uint32_t, float	eax, ebx, ecx, edx, edi
QWORD   Quad Word	    8 bytes	                        64 bits	uint64_t, double, Punteros (*)	rax, rbx, rcx, rdx, rdi, r8
DQWORD  Double Quad)    16 bytes	                        128 bits	Arreglos vectoriales, __m128	xmm0, xmm1, xmm2
